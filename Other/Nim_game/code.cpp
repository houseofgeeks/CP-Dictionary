...
//just change the input variables and your code is ready to be used





#include <iostream>//header file that contains input output stream
#include <math.h>//header file tha contains all the math functions
using namespace std;
